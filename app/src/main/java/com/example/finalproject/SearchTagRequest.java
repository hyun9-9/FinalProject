...
public class SearchTagRequest extends StringRequest {
    //서버 url 설정(php파일 연동)
    final static  private String URL="http://3.39.213.10/api/recipies";
    private Map<String, String> map;
    private HashMap<String, String> headers;
    String tokenEncoded;
    String token;
    public SearchTagRequest(String Token, Response.Listener<String> listener, String testDataSet){


        super(Request.Method.GET, URL+"?"+testDataSet, listener,
