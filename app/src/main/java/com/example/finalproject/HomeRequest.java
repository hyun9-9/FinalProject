...
public class HomeRequest extends StringRequest {
    //서버 url 설정(php파일 연동)
    final static  private String URL="http://3.39.213.10/api/recipies/recommend";
    private Map<String, String> map;
    private HashMap<String, String> headers;
    String tokenEncoded;
    String token;
    public HomeRequest(String Token, Response.Listener<String> listener){


        super(Request.Method.GET, URL+"?limit=5", listener,
