...
public class RecipeproRequest extends StringRequest {
    //서버 url 설정(php파일 연동)
    final static  private String URL="http://3.39.213.10/api/processes/";
    private Map<String, String> map;
    private HashMap<String, String> headers;
    String tokenEncoded;
    String token;
    public RecipeproRequest(String Token, String id, Response.Listener<String> listener){


        super(Method.GET, URL+id, listener,
